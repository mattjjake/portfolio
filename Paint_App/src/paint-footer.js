...
class PaintFooter extends HTMLElement{
    constructor(){
      super();
    ...
    render(){
        ...
        this.shadowRoot.querySelector("span").innerHTML = `&copy; Copyright ${name}, ${text}`;
    }
  } 
	
  customElements.define('paint-footer', PaintFooter);