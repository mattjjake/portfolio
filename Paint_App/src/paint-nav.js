...
<nav class="navbar has-shadow is-white" style=" position: absolute; width: 100%;     z-index: 51;">
...
class PaintNav extends HTMLElement{
    constructor(){
      super();
  ...
  customElements.define('paint-nav', PaintNav);