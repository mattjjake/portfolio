#ifndef __GGP_SHADER_INCLUDES_PBR_ // Each .hlsli file needs a unique identifier!
#define __GGP_SHADER_INCLUDES_PBR_
...
// See slide 65: http://blog.selfshadow.com/publications/s2014-shading-
// course / hoffman / s2014_pbs_physics_math_slides.pdf
...
float3 MicrofacetBRDF(float3 n, float3 l, float3 v, float roughness, float3 specColor)
{
	...
	// See page 16: http://blog.selfshadow.com/publications/s2012-shading-
	// course / hoffman / s2012_pbs_physics_math_notes.pdf
